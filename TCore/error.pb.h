...
constexpr ErrorType ErrorType_MIN = SUCCESS;
constexpr ErrorType ErrorType_MAX = UNKNOW;
...
template <> struct is_proto_enum< ::gamepb::ErrorType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::gamepb::ErrorType>() {
  return ::gamepb::ErrorType_descriptor();
}
