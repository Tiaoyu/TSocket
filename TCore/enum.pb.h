...
constexpr ProtocolType ProtocolType_MIN = EC2SPing;
constexpr ProtocolType ProtocolType_MAX = ES2CGobangStep;
...
template <> struct is_proto_enum< ::gamepb::ProtocolType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::gamepb::ProtocolType>() {
  return ::gamepb::ProtocolType_descriptor();
}
